...
architect/references/title-taxonomy.md`'s existing Phase 1.5 (base file
...
`references/content-model-overlap.md` adds one derived index this skill
...
`onboarding/references/starting-out-track.md` — this skill's own role in
...
20-interests-profile/references/riasec-mapping.md`'s RIASEC vector, same batched-confirm,
